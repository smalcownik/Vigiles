...
define([], function () {
    ...
    exported.makeRequest = function (imageData) { // f-kcja wywołana w ImageDataAdding.executeAddingNewImage
        ...
        http_request.open("POST", viewer.serverURL /*+ "/imageData"*/,false); // tutaj zmienić url na odpalony serwer na amazonie (dziala z serwerem TODO: dodać request url pliku
