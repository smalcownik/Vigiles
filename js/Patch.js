...
define([], function () {
        ...
        var exported = function Patch(image,parent,data,i){
            ...
            imgHTML.src=data.url+'/data/test_arch/imgs/imgs['+i+']/'+image.id+'.jpg'; //  tu jest odniesienie do plików jpg (jedyne!!) //TODO: 16.11.2016 tutaj trzeba zmieniac fragment "test_arch" w zalezności od wyboru paczki
