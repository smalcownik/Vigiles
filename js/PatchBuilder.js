            ...
            exported.build = function(data){
                ...
                data.traverse( //TODO: a to traverse to z kąd - z MapData?? w jaki sposób tu jest odniesienie do map data - ahaaaa data:MapData
                    function(image,parent){
                        //debugger;
                        exported.buildImage(data,image/*,function(){console.log(" w buildImage callback")}*/
                        //image - to pochodzi z traverse->dig (MapData) , gdzie image jest na siłę wstawiony this.images[0]
                        );
